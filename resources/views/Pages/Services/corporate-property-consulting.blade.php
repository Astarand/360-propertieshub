...
@section('title', 'Corporate Property Consulting in Kolkata - 360 Properties Hub')
@section('meta_description', 'Expert corporate property consulting services in Kolkata with strategic advisory, portfolio management, and commercial real estate solutions for businesses across West Bengal.')
@section('meta_keywords', 'corporate property consulting Kolkata, commercial real estate advisory West Bengal, business property consulting Kolkata, corporate real estate Bengal, property advisory services Kolkata, commercial property West Bengal')
@section('canonical_url', url()->current())
@section('og_title', 'Corporate Property Consulting in Kolkata - 360 Properties Hub')
@section('og_description', 'Professional corporate property consulting in Kolkata with strategic advisory and commercial real estate solutions for businesses.')
@section('og_image', asset('assets/images/corporate-property-consulting.jpg'))
